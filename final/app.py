...
def get_routes():
    ...
    for nodo_intermedio in nodos_intermedios:
        ...
        camino_completo.extend(segmento[1:])  # Agregar el segmento sin el primer nodo (ya está en camino_completo)s
    ...
    distancia_total_metros = sum(geodesic(coordenadas_ruta[i], coordenadas_ruta[i+1]).meters for i in range(len(coordenadas_ruta)-1))
    distancia_total_km = distancia_total_metros / 1000  # Convertir de metros a kilómetros
